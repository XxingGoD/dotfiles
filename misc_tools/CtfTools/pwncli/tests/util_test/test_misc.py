...
class TestOther:
    ...
    def test_reveal_heapbase(self):
        assert reveal_heapbase(0x5599346008cd) == 0x559c6da6d000
        assert reveal_heapbase(0x5599346008cd, pos=0x559c6da6d3b0) == 0x559c6da6d000
        assert reveal_heapbase(0x5599346008cd, pos=0x559c6da6d3b0, offset=0x2a0) == 0x559c6da6d000
        assert reveal_heapbase(0x559c6da6d, null_fd=True) == 0x559c6da6d000
        assert reveal_heapbase(0x559c6da6d, pos=0x559c6da6d2a0, null_fd=True) == 0x559c6da6d000
