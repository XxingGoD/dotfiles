...
local mappings = {
	builtins = {
		...
		["i|<Down>"] = map_cmd("<C-o>j"):with_noremap():with_silent():with_desc("edit: Move cursor down"),
		["i|<Up>"] = map_cmd("<C-o>k"):with_noremap():with_silent():with_desc("edit: Move cursor up"),
		...
		-- Builtins: Fold navigation
		["n|<leader>zM"] = map_cr("set foldlevel=0"):with_noremap():with_silent():with_desc("fold: Close all folds"),
		["n|<leader>zR"] = map_cr("set foldlevel=99"):with_noremap():with_silent():with_desc("fold: Open all folds"),
		["n|<leader>zj"] = map_cr("normal zj"):with_noremap():with_silent():with_desc("fold: Move to next fold"),
		["n|<leader>zk"] = map_cr("normal zk"):with_noremap():with_silent():with_desc("fold: Move to previous fold"),
		["n|<leader>zm"] = map_cr("foldclose"):with_noremap():with_silent():with_desc("fold: Close current fold"),
		["n|<leader>zr"] = map_cr("foldopen"):with_noremap():with_silent():with_desc("fold: Open current fold"),
		["n|<leader>zf"] = map_cr("normal zf"):with_noremap():with_silent():with_desc("fold: Create fold (motion)"),
		["n|<leader>zd"] = map_cr("normal zd"):with_noremap():with_silent():with_desc("fold: Delete current fold"),
	},
	plugins = {
		...
		["nv|<leader>k"] = map_callback(function()
			...
			:with_silent()
			:with_noremap()
			:with_desc("jump: Goto previous line"),
