...
return function()
	...
	local function custom_theme()
		...
		if has_catppuccin then
			...
			local transparent_bg = require("core.settings").transparent_background
			local universal_bg = transparent_bg and "NONE" or colors.mantle
			-- Keep background for section A to ensure the arrow separator  is colored
			local section_a_bg = colors.surface0
			return {
				normal = {
					a = { fg = colors.lavender, bg = section_a_bg, gui = "bold" },
					b = { fg = colors.text, bg = universal_bg },
					c = { fg = colors.text, bg = universal_bg },
				},
				command = {
					a = { fg = colors.peach, bg = section_a_bg, gui = "bold" },
				},
				insert = {
					a = { fg = colors.green, bg = section_a_bg, gui = "bold" },
				},
				visual = {
					a = { fg = colors.flamingo, bg = section_a_bg, gui = "bold" },
				},
				terminal = {
					a = { fg = colors.teal, bg = section_a_bg, gui = "bold" },
				},
				replace = {
					a = { fg = colors.red, bg = section_a_bg, gui = "bold" },
				},
				inactive = {
